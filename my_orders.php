      ...
      <table>
        ...
        <tbody>
          <?php foreach ($bookings as $booking): 
            ...
            $statusLabel = $is_past ? "Completed" : ucfirst($booking['status']);
          ?>
            <tr>
              ...
              <td class="action-cell">
                <a href="booking_summary.php?booking_id=<?= $booking['id'] ?>">View</a>
              </td>
            </tr>
          <?php endforeach; ?>
        </tbody>
